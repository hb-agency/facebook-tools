...
/**
 * Class ContentFBToolsComments
 *
 * Front end content element "Facebook Comments Feed".
 ...
 * @license    LGPL
 */
class ContentFBToolsComments extends ContentElement
{
	 ...
	 * @var string
	 */
	protected $strTemplate = 'ce_fbtools_comments';
